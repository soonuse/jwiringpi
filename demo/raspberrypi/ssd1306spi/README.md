# SSD1306 OLED (0.96inch OLED) demo
This demo is written in Java and tested with a Waveshare SSD1306 0.96inch OLED module working on Raspberry Pi 3 Model B.
