# SSD1331 OLED (0.95inch RGB OLED) demo
This demo is written in Java and tested with a Waveshare SSD1331 0.95inch RGB OLED module working on Raspberry Pi 3 Model B.
