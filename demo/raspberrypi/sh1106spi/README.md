# SH1106 OLED (1.3inch OLED) demo
This demo is written in Java and tested with a Waveshare SH1106 1.3inch OLED module working on Raspberry Pi 3 Model B.
Before running this demo, you have to enable the SPI interface on the Raspberry Pi. See `sudo raspi-config`
## How to use
...
4.  run with<br />
        `java SH1106SPIDemo`
### Note
*   If you don't want to copy the library to the /usr/lib, you can specify the library path before running your Java program, like:
